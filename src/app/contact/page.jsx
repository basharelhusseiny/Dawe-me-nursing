...
const Contact = () => {
  ...
  return (
    <div className="py-16 bg-gradient-to-b from-white to-sky-200">
      <div className="container mx-auto px-5">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto text-gray-600">
            نحن هنا للإجابة على استفساراتك وتقديم المساعدة. يمكنك التواصل معنا
            من خلال أي من الوسائل التالية أو ملء النموذج أدناه.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-start mb-10">
          ...
          >
            ...
            >
              ...
              <form
                action="https://formsubmit.co/hossam.mahmoud.395@gmail.com"
                method="POST"
              >
                <div className="mb-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-sky-500 to-sky-700 hover:from-sky-600 hover:to-sky-800 text-white font-bold py-3 px-4 rounded-md transition-colors duration-300"
                >
                  إرسال الرسالة
                </button>
              </form>
